              ...
              <v-container>
                <v-form v-bind:disabled="loading" lazy-validation ref="dialogForm">
                  ...
                  <v-col cols="12" sm="6" md="6">
                    <v-text-field :disabled="loading" :rules="titleRule" v-model="editedItem.category" label="Category Name"></v-text-field>
                  </v-col>

                  <v-col cols="12" sm="6" md="6">
                    <v-text-field :disabled="loading" :rules="titleRule" v-model="editedItem.desc" label="Category description"></v-text-field>
                  </v-col>
  ...
  data() {
    return {
...

      {
        ...
        // { text: "Category Image URL", value: "desc" },
