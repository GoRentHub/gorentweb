      ...
      <v-row align="center" justify="center">
        <v-col cols="12"
          ...
          <v-card class="mx-auto" shaped elevation="20">
            ...
            <v-toolbar color="#f7b116" dark flat>
              <v-toolbar-title class="headline">Go Renthub Admin Panel</v-toolbar-title>
            </v-toolbar>
            ...
            <v-card-actions>
              <v-btn v-bind:disabled="disabled"  block @click="validate" color="#098add">
                <span style="color:whitesmoke;" v-show="!disabled">Login</span>
